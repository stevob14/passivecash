...
<label>End Year:  </label>
 <input id="endYearField" type="number" value="2024" min="1913" max="2024" oninput="javascript: if (this.value.length &gt; this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="128" onkeypress="return isNumberKey(event)"/>
 </p>
<p>
